# Generated by Django 2.2 on 2020-11-30 18:52
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(help_text='A non-unique name for this GeoPackage.', max_length=256, verbose_name='Name')),
                ('description', models.TextField(help_text='A description of this GeoPackage.', max_length=5000, verbose_name='Description')),
                ('thumbnail_image', models.ImageField(blank=True, help_text='Please upload an image that demonstrate this GeoPackage.', null=True, upload_to='resources/%Y', verbose_name='Thumbnail')),
                ('gpkg_file', models.FileField(help_text='A GeoPackage file.', upload_to='resources/%Y', validators=[django.core.validators.FileExtensionValidator(allowed_extensions=['gpkg'])], verbose_name='GeoPackage file')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('geopackage', models.ForeignKey(blank=True, help_text='The reviewed GeoPackage', null=True, on_delete=django.db.models.deletion.CASCADE, to='resources.Geopackage', verbose_name='GeoPackage')),
